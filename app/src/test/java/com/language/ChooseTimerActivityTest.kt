...
class ChooseTimerActivity : AppCompatActivity() {
    ...
    private fun setupClickListeners() {
        ...
        plusIcon.setOnClickListener {
            ...
            updateTimerDisplay()
            if (timerLogic.totalSeconds >= 300) {
                Toast.makeText(this, "Maximum time is 5 minutes", Toast.LENGTH_SHORT).show()
            }
        }
        ...
        startButton.setOnClickListener {
            ...
            Log.d("ChooseTimerActivity", "Time: ${timerLogic.totalSeconds} seconds")
            Log.d("ChooseTimerActivity", "Players: ${players.joinToString { it.name }}")
            Log.d("ChooseTimerActivity", "Sets: ${selectedSets.joinToString()}")

            val intent = Intent(this, PlayActivity::class.java).apply {
                putExtra("totalTimeInMillis", timerLogic.totalSeconds * 1000L)
    ...
    private fun updateTimerDisplay() {
        timerText.text = timerLogic.formatTimerText()
    }
